...
return [
     ...
     */
    'model' => \NIk\Comments\Comment::class,
     ...
     */
    'permissions' => [
        'create-comment' => 'NIk\Comments\CommentPolicy@create',
        'delete-comment' => 'NIk\Comments\CommentPolicy@delete',
        'edit-comment' => 'NIk\Comments\CommentPolicy@update',
        'reply-to-comment' => 'NIk\Comments\CommentPolicy@reply',
    ],

    /**
     * The Comment Controller.
     * Change this to your own implementation of the CommentController.
     * You can use the \NIk\Comments\CommentControllerInterface
     * or extend the \NIk\Comments\CommentController.
     */
    'controller' => '\NIk\Comments\WebCommentController',
